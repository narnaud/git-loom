...
describe "drop HEAD commit removes it"
...
describe "drop a non-HEAD commit (middle of stack)"
setup_repo_with_remote
...
describe "drop a commit on a woven feature branch"
setup_repo_with_remote
...
describe "drop fails gracefully on unknown target"
setup_repo_with_remote
